...
/**
 * @file
 * @brief Trace Library internal header
 ...
 * directly without the need to embed the Core Engine.
 */
...
// If we are using the Trace library with the Core Engine, then map the functions
